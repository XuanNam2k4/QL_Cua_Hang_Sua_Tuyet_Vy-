...
{
    public class Product_64131375Controller : Controller
    {
        private Project_64131375Entities db = new Project_64131375Entities();

        //// GET: Product_64131375
        //public ActionResult Index()
        //{
        //    var sanPhamSuas = db.SanPhamSuas.Include(s => s.HangSanXuat).Include(s => s.LoaiSua).Include(s => s.NhaCungCap);
        //    return View(sanPhamSuas.ToList());
        //}

        // GET: Product_64131375/Details/5
        ...
        //// POST: Product_64131375/Delete/5
